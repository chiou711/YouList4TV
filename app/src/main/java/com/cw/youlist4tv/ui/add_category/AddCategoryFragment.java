...
package com.cw.youlist4tv.ui.add_category;
...
import com.cw.youlist4tv.import_new.Import_fileListAct;
import com.cw.youlist4tv.import_new.gdrive.ImportGDriveAct;
        ...
        setOnItemViewClickedListener(new OnItemViewClickedListener() {
            ...
            public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
                ...
                if(clickedSrcLinkNum == 1){ // local link source
                    ...
                    // path: /storage/emulated/0/Android/data/com.cw.youlist4tv/files/Documents
...
class SrcStringPresenter extends Presenter {
    ...
    public  void onBindViewHolder(ViewHolder viewHolder, Object item) {
        ...
        if(item.toString().equalsIgnoreCase("Local_YouList4TV"))
